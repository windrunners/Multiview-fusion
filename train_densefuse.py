...
def train(i, j, original_imgs_path):
	...
	for e in tbar:
		...
		for batch in range(batches):
			...
			# all_crossentropy_loss += crossentropy_loss_value.item()
			...
			if (batch + 1) % args.log_interval == 0:
				...
				# Loss_crossentropy.append(all_crossentropy_loss / args.log_interval)
